...
public class BaremeController {
    ...
    @RequestMapping(value="/selectionnerBareme/{iddemandecredit}", method=RequestMethod.GET)
    public Bareme selectionnerBareme (@PathVariable(value = "iddemandecredit") Long id) {

       return  baremeService.selectionnerBareme(id);
    }
